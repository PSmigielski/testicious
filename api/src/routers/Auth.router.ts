...
authRouter.get("/verify/:requestId", checkUuid("requestId"),authController.verify.bind(authController));
...
authRouter.put("/reset/:requestId", checkUuid("requestId"), schemaValidator("/../../schemas/reset.schema.json"), authController.reset.bind(authController));
...
authRouter.put("/edit/role/:id", checkJwt, checkRole(Roles.ADMIN), checkUuid("id"),schemaValidator("/../../schemas/changeRole.schema.json"), authController.changeRole.bind(authController));
