...
toppingRouter.delete("/:toppingId", checkJwt, checkRole(Roles.ADMIN), checkUuid("toppingId"),toppingController.removeTopping.bind(toppingController));
toppingRouter.put("/:toppingId", checkJwt, checkRole(Roles.ADMIN), checkUuid("toppingId"), schemaValidator("/../../schemas/editTopping.schema.json"), toppingController.editTopping.bind(toppingController));
